...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'About — Ano Global Holdings', description: 'Ano Global Holdings is a strategic platform registered in Hong Kong, operating across energy, infrastructure, human development, and global partnerships.', url: '/about', images: [{ url: '/og/about.png', width: 1200, height: 630, alt: 'About — Ano Global Holdings' }] },
  twitter: { card: 'summary_large_image', title: 'About — Ano Global Holdings', description: 'Ano Global Holdings is a strategic platform registered in Hong Kong, operating across energy, infrastructure, human development, and global partnerships.', images: ['/og/about.png'] },
}
