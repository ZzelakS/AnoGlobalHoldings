...
import { Rule } from './ui'
import { BUILT_BY, COMPANIES, NAV, SITE } from '@/config/site'
        ...
        <div className="content">
          ...
          <div className="mt-12 grid gap-12 md:grid-cols-3">
            <div>
              ...
              <p className="mt-4 text-[15px] text-[#DCD8CC]">New York · Hong Kong · Lagos</p>
              <a
          ...
          <div className="mt-16 border-t border-white/10 pt-8">
            <p className="text-[14px] text-[#DCD8CC]/75">
              ...
              <span className="font-semibold text-gold">{BUILT_BY.name}</span>
            </p>
          </div>
        </div>
      </div>
